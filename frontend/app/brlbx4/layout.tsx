...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.a-eq.com"),
  title,
  description,
  keywords,
  ...
  openGraph: {
    ...
    type: "website",
    locale: "en_US",
    url: "https://www.a-eq.com/BLRBX4.0",
...
export default function Brlbx4Layout({ children }: { children: React.ReactNode }) {
  return (
    <div
